...
class UsdtSellController extends BaseController
{
    protected function _initialize()
    {
        parent::_initialize();
        $this->permissions();
        $this->assign('navbar', 'usdtsell');
    }
    ...
    public function ajaxData(){
        ...
        foreach($result as $k => $v){
            ...
            switch($result[$k]['status']){
                case 2:
                    $result[$k]['checkstatus'].= '<button type="button" lay-event="checkpass" class="layui-btn layui-btn-xs layui-btn-radius">已打款</button>';
                    ...
                    break;
                case 3:
                    $result[$k]['checkstatus'] = '<span class="layui-badge layui-bg-green">已打款</span>';
                    break;
                case 5:
