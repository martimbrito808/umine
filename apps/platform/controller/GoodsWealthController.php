...
class GoodsWealthController extends BaseController
{
    ...
    protected function _initialize()
    {
        parent::_initialize();
        $this->permissions();
        $this->assign('navbar', 'goodswealth');
        ...
        if ($this->request->isPost()) {
            ...
            switch($this->param['zhouqi']) {
                ...
                case '30' :
                    ...
                    break;
                case '60' :
                    $this->param['apr_6'] = $this->param['apr'];
                    break;
                case '90' :
                    $this->param['apr_9'] = $this->param['apr'];
                    break;
                case '120' :
                    $this->param['apr_12'] = $this->param['apr'];
                    break;
            }
            // 添加|修改  插入数据库
            if (empty($id)) {
